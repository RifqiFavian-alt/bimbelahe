  ...
  return (
    <div className="w-full h-full px-5 md:px-20 lg:px-24 pt-20 pb-40">
      ...
      <div className="mt-10 flex flex-col w-full lg:w-6/12 mx-auto py-16 border-b-2 border-[#B2A0DA] text-center gap-y-3">
        ...
        <button type="submit" className="questionnaires__form-input-user__submit focus:outline-none text-sm bg-[#7E60BF] text-white py-2 rounded-sm mt-5 w-60 m-auto" onClick={handleFinish}>
          Kembali
        </button>
      </div>
    </div>
